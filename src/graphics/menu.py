...
class Menu:
    def __init__(self, screen):
        ...
        Luo fontit otsikolle, tekijän nimelle ja valikkovaihtoehdoille. Tallentaa valikkovaihtoehdot listana."""
        self.screen = screen
    ...
    def draw(self):
        ...
        Piirtää otsikon, tekijän nimen ja valikkovaihtoehdot. Valittu vaihtoehto korostetaan.
        """
        self.screen.fill((0, 0, 0))
        # title and creator text
        title = self.font_title.render("TETRIS", True, (255, 255, 255))
        creatortext = self.font_creator.render("By A5Beef", True, (255, 255, 255))
